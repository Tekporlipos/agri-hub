                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                            <div class="account-box">
                                <div class="service-box">
                                    <div class="service-desc">
                                        <h4>AGRIC MACHINERY&amp;FERTILIZERS</h4>
                                        <ul>
                                            <li> <a href="#">IMPORT MACHINES </a> </li>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="account-box">
                                <div class="service-box">
                                    <div class="service-desc">
                                        <h4>ADVERTISEMENT &amp; BRAND CREATING FOR ALL FARMERS</h4>
                                        <ul>
                                            <li> <a href="#">Advertising preferences </a> </li>
                                            <li> <a href="#">Communication preferences</a> </li>
                                            <li> <a href="#">CREATE A BRAND NOW</a> </li>
                                ...
                                <div class="service-box">
                                    <div class="service-desc">
                                        ...
                                        <ul>
                                            ...
                                            <li> <a href="#">FACULTY OF APPLIED SCIENCE </a> </li>
                                            <li> <a href="#">COMPUTER SCIENCE DEPARTMENT</a> </li>
                                            <li> <a href="#">NZIMA MENSAH HALL</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="account-box">
                                <div class="service-box">
                                    <div class="service-desc">
                                        <h4>LOCAL FARMERS SUPPORT</h4>
                                        <ul>
                                            <li> <a href="#">KOFI BOADU AGRIC FOUNDATION</a> </li>
                                            <li> <a href="#">ROCKS FARMS</a> </li>
                                            <li> <a href="#">VENUS FARMS</a> </li>
                                            <li> <a href="#">WE-CARE AQUA FARMS</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
