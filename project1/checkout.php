            ...
            <div class="row">
                    ...
                    <div class="checkout-address">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="telephone " id="address" placeholder="">
                            </div>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                                ...
                                <div class="rounded p-2 bg-light">
                                    ...
                                    ?>
                                            <div class="media mb-2 border-bottom">
                                                <div class="media-body"> <a href="./shop-detail.php?product_id=<?php echo $row['id'] ?>"> <?php echo $row['name'] ?></a>
                                                    <div class="small text-muted">Price: $<?php echo $row['price'] ?> <span class="mx-2">|</span> Qty: <?php echo $row['quantity'] ?> <span class="mx-2">|</span> Subtotal: $<?php echo $row['price'] * $row['quantity'] ?></div>
                                                </div>
                                            </div>
                                    <?php
                                        }
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="order-box">
                                        ...
                                        <div class="d-flex gr-total">
                                            <h5>Grand Total</h5>
                                            <div class="ml-auto h5"> $ <?php echo $total + 2 ?> </div>
                                        </div>
                                        <hr>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="checkout.php" name="orders" class="ml-auto btn hvr-hover">order</a> </div>
                    </div>
                    </form>
